...
namespace Oxide.Plugins
{
    ...
    public class BStats : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            ImageLibrary?.Call("AddImage", "https://i.ibb.co/CHgbVGh/icons8-numbers-30.png", "avatar.icon");
            ImageLibrary?.Call("AddImage", "https://i.ibb.co/CHgbVGh/icons8-numbers-30.png", "line.icon");
        }
