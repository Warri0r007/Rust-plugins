...
{
    [Info("DeathMessages", "VooDoo", "1.4.8")]
    ...
    public class DeathMessages : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            AddImage($"https://ru-wiki.rustclash.com/img/items180/skull.human.png", "headshot", 1336);
        ...
        private void OnDeath(BasePlayer victim, BasePlayer initiator, HitInfo hitInfo)
        {
            ...
            float sDistance = fDistance > 1000 ? 1000 : fDistance;
