    ...
    class BMenu : RustPlugin
    {
        ...
        private void LoadImages()
        {
            ...
            { 
                ...
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/c1P36CsW/T3-IN2-qz.png", "time");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/MTK70F48/dleUagul.png", "online");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/NFsscPcX/icons8-80-2.png", "store");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/cLCM8jpy/fgfgfg-Bgv.png", "cargo");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/V6QjpNdm/dfnx4pnW.png", "hell");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/xCvK2SzH/bq-B9-Gfgkb.png", "bradley");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/P5CYqDDd/siendfdfgh-Tf8.png", "plane");
            }
        }
        ...
        private void EntityHandle(BaseEntity entity, bool spawn)
		{
            ...
            {
                Events["plane"] = spawn ? "0.51 0.69 0.13 1.00" : "1 1 1 0.8";
                foreach (var player in BasePlayer.activePlayerList)
                {
            ...
            {
                Events["bradley"] = spawn ? "0.51 0.69 0.13 1.00" : "1 1 1 0.8";
                foreach (var player in BasePlayer.activePlayerList)
                {
                    if(MenuUsers2.Contains(player)) return;
            ...
            {
                Events["hells"] = spawn ? "0.51 0.69 0.13 1.00" : "1 1 1 0.8";
                foreach (var player in BasePlayer.activePlayerList)
                {
                    if(MenuUsers2.Contains(player)) return;
		...
		{
		    // Замените возвращаемое значение на фейковый онлайн
        ...
        public void RefreshUI(BasePlayer player ,string Type)
        {
            ...
            switch(Type)
            {
                case "timeandonline":
                    ...
                    UI.AddText(ref c, Layer + "time", Layer + "text.time", "1 1 1 1", TOD_Sky.Instance.Cycle.DateTime.ToString("HH:mm"), TextAnchor.MiddleCenter, 11, "0 0", "1 1", "", "");
                ...
                case "hells":
                    ...
                    UI.AddImage(ref c, Layer, Layer + "events", "0.8 0.8 0.8 0.2", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "40.334 -35.48", "55.547 -20.878");
                ...
                case "bradley":
                    ...
                    UI.AddImage(ref c, Layer, Layer + "events2", "0.8 0.8 0.8 0.2", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "60.334 -35.48", "76.547 -20.878");
                ...
                case "plane":
                    ...
                    UI.AddImage(ref c, Layer, Layer + "events4", "0.8 0.8 0.8 0.2", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5",  "20.334 -35.48", "35.547 -20.878");
                ...
                case "all":
                    ...
                    UI.AddImage(ref c, Layer, Layer + "menu", "0.8 0.8 0.8 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "-16.615 -35.48", "16.613 -20.878");
                    UI.AddText(ref c, Layer + "menu", Layer + "text.menu", "1 1 1 0.9", $"/MENU", TextAnchor.MiddleCenter, 10, "0 0", "1 1", "", "");
                    UI.AddButton(ref c, Layer + "menu", Layer + "menu.button", "chat.say /menu", "", "0 0 0 0", "", "", "0 0", "1 1", "", "");

                    UI.AddText(ref c, Layer + "time", Layer + "text.time", "1 1 1 0.9", "12:00", TextAnchor.MiddleCenter, 11, "0 0", "1 1", "", "");
                    UI.AddText(ref c, Layer + "online", Layer + "text.online", "1 1 1 0.9", $"{GetOnline()}/{ConVar.Server.maxplayers}", TextAnchor.MiddleCenter, 11, "0 0", "1 1", "", "");
                    UI.AddImage(ref c, Layer, Layer + "events", "0.8 0.8 0.8 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "40.334 -35.48", "55.547 -20.878");
                    UI.AddRawImage(ref c, Layer + "events", Layer + "icon.events", ImageLibrary?.Call<string>("GetImage", "hell"), Events["hells"], "", "", "0 0", "1 1", "2 2", "-2 -2");
                    UI.AddImage(ref c, Layer, Layer + "events2", "0.8 0.8 0.8 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "60.334 -35.48", "76.547 -20.878");
                    ...
                    UI.AddImage(ref c, Layer, Layer + "events4", "0.8 0.8 0.8 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "20.334 -35.48", "35.547 -20.878");
                    ...
                    UI.AddButton(ref c, Layer, Layer + "invise", "menuOpen", "", "0.8 0.8 0.8 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "153.043 2.012", "168.255 16.61");
                ...
                case "open":
                    ...
                    UI.AddButton(ref c, Layer, Layer + "invise2", "menuOpen", "", "0.8 0.8 0.8 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "20 2.012", "35 16.61");
        ...
        public void Main_menu(BasePlayer player)
        {
            ...
            UI.AddImage(ref c, Layer, Layer + "store", "0.8 0.8 0.8 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "-16.617 -16.607", "16.607 16.617");
        ...
        protected override void LoadDefaultConfig()
        {
            config = new PluginConfig
            {
                ...
                {
                    "ЕЖЕДНЕВНЫЕ КЕЙСЫ", "Задание сидоривича", "прокачка навыков", "обмен монет","разблок предметов","клановое меню","рейтинг кланнов", "Рейтинг игроков", "телепорт в город", "ропорт на игрока", "инвентарь с ящиками"
                },
