...
namespace Oxide.Plugins
{
    ...
    public class Clans : RustPlugin
    {
        ...
        void OnServerInitialized()
        {
            ...
            foreach (var player in BasePlayer.activePlayerList) ClanTopg(player, 0);
        ...
        // {
        //     if (!entity.PrefabName.Contains("autoturret_deployed")) return;
        //     //if (!entity("autoturret_deployed")) return;
        ...
        //     {
        //         clan.turret++;
        //         player.ChatMessage($"Вам осталось турелей (на клан): <color=orange>{60 - clan.turret}</color>");
        //     }
        // }
        ...
        void PointClanGUI(BasePlayer player)
        {
            timer.Every(3f, () =>
            {
                var clan = findClanByUser(player.UserIDString);
                if (clan == null) return;
                CuiHelper.DestroyUi(player, PointLayer);
                    ...
                    Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 0.6", Text = $"У вашего клана: {clan.ClanPoints} очков.", Align = TextAnchor.MiddleCenter,  FontSize = 15 },
                                new CuiRectTransformComponent{ AnchorMin = $"0 0", AnchorMax = $"0 0", OffsetMin = " 0", OffsetMax = "300 20" },
                            }
                });
        ...
        void NewClanUI(BasePlayer player, bool leadermode = false)
        {
            ...
            {
                CursorEnabled = true,
                Image = { Color = "0 0 0 0.7", Sprite = "assets/content/ui/ui.background.tile.psd" },
            ...
            {
                CursorEnabled = false,
                Image = { Color = "0.3294118 0.3294118 0.3294118 0.9", Sprite = "assets/content/ui/ui.background.tile.psd" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiButtonComponent { Color = "0.141 0.137 0.109 0", Sprite = "assets/content/ui/ui.background.transparent.radial.psd" , Close = Main},
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 1", Text = $"КЛАНОВАЯ СИСТЕМА", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf",  FontSize = 22 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "0.81 0.81 0.81 1.00", Text = $"Количество очков вашего клана: {clan.ClanPoints}, фарма: {clan.Farm}, очков за рейд: {clan.raidpoint}",
                                    Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 13 },
                                new CuiRectTransformComponent{ AnchorMin = $"0 0.88", AnchorMax = $"1 0.93" },
                            }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 1", Text = $"КЛАНОВАЯ ОДЕЖДА", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 25 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 0.5", Text = $"Данные скины будут автоматически изменяться у участников клана", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 13 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 1", Text = $"ДОБЫЧА РЕСУРСОВ", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 25 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 0.5", Text = $"Норма добычи ресурсов установлено лидером клана", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 13 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 1", Text = $"УЧАСТНИКИ КЛАНА", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 25 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 0.5", Text = $"Нажмите на одного из участников, чтобы получить дополнительную информацию. Онлайн игроки подсвечены <color=#97D499>зелёным</color> цветом", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 13 },
            ...
            foreach (var member in clan.members)
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 1", Text =  GetPlayerStatus(member.Key, clan), Align = TextAnchor.UpperCenter, Font = "robotocondensed-bold.ttf", FontSize = 10 },
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 1", Text =mem.Name, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 10 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 0", Text =  "ДОПОЛНИТЕЛЬНАЯ ИНФОРМАЦИЯ", Align = TextAnchor.UpperCenter, Font = "robotocondensed-bold.ttf", FontSize = 25 },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 0", Text = $"Лидеру клана доступна настройка скинов одежды, оружия и норма добычи ресурсов. Нажмите на иконку скина, или ресурса.".ToUpper(), Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 13 },
                                new CuiRectTransformComponent{ AnchorMin = $"0 0", AnchorMax = $"1 0.09" },
                            }
            });
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = $"-30 -30", OffsetMax = "-5 -5" },
                Button = { Color = "0.929 0.882 0.847 0.6", Sprite = "assets/icons/close.png", Close = Main },
                Text = { Text = "" }
            }, MainLayer);
            CuiHelper.AddUi(player, container);
        }
                         ...
                         clan,
                            (where, user) =>
                            {
                                if (current)
                                    ...
                                    foreach (var x in where.authorizedPlayers.ToArray())
                                        if (x.userid.ToString() == user)
                                            where.authorizedPlayers.Remove(x);
                                    // where.authorizedPlayers.RemoveWhere(x => x.userid.ToString() == user);
        ...
        void cmdClansGetSkinList(ConsoleSystem.Arg args)
        {
            ...
            var SkinLists = SkinList[args.Args[0]].Select(p => p.Value).Skip(page * 45).ToList();
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiButtonComponent {Color = "0.14 0.14 0.14 0.7" , Sprite = "assets/content/ui/ui.background.tile.psd" , Command = $"UI_CLAN close clans_skinlist1 UICLAN_edit"},
                        new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
            });
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiButtonComponent {Color = "0 0 0 0.6" },
                        new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
            });
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = "<size=20>ВЫБЕРИТЕ НУЖНЫЙ СКИН ПРОСТО НАЖАВ НА НЕГО</size>", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"},
                        new CuiRectTransformComponent { AnchorMin = "0 0.8", AnchorMax = "1 1" },
                    }
            });

            var poses = GetPositions(9, 5, 0.01f, 0.01f);
            if (SkinLists.Count > 45) SkinLists.Take(45);
            var count = SkinLists.Count < 45 ? SkinLists.Count : 45;
            for (int i = 0; i < count; i++)
            {
                elements.Add(new CuiElement
                {
                    Name = "clans_skinlist" + SkinLists[i],
                    Parent = "clans_skinlist",
                    Components =
                    {
                        new CuiImageComponent {FadeIn = 0.5f, Color = "0 0 0 0.7"},
                ...
                elements.Add(new CuiElement
                {
                    Parent = "clans_skinlist" + SkinLists[i],
                    Components =
                    {
                        new CuiRawImageComponent {FadeIn = 0.5f , Png = GetImageSkin(args.Args[0], SkinLists[i])},
                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
                });
                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 0", Command = $"clan_changeskin {args.Args[0]} {SkinLists[i]}" },
                    Text = { Text = "", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"1 1" },
                }, "clans_skinlist" + SkinLists[i]);
            }
                ...
                Components =
                    {
                        ...
                        new CuiRectTransformComponent {AnchorMin = "0.2 -0.125", AnchorMax = "0.8 -0.025"}
                    }
            });
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = "<size=14>ТАК ЖЕ ВЫ МОЖЕТЕ СЮДА ВВЕСТИ ID СВОЕГО СКИНА</size>", Color = "1 0.9294118 0.8666667 0.7", Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter},
                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" },
                    }
            });
            ...
            elements.Add(new CuiElement()
            {
                ...
                Components =
                {
                    new CuiInputFieldComponent
                    {
                        ...
                        CharsLimit = 64,
                        FontSize = 26,
                        Command = $"clan_changeskin {args.Args[0]} ",Font = "robotocondensed-bold.ttf",
                        Text = "",
                        Color = "1 1 1 1"
                    },
                    new CuiRectTransformComponent
        ...
        void cmdSetChangeOfClan(ConsoleSystem.Arg args)
        {
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = "<size=25>ВВЕДИТЕ НУЖНЫЕ ЗНАЧЕНИЯ В ПОЛЯ, ДЛЯ СОХРАНЕНИЯ НАЖМИТЕ ОК</size>", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"},
                        new CuiRectTransformComponent { AnchorMin = "0 0.8", AnchorMax = "1 1" },
                    }
            });
            ...
            for (int i = 0; i < clan.Change.Count; i++)
            {
                ...
                elements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiTextComponent { Text = $"Установлено:\n{clan.Change.ToList()[i].Value.Need.ToString("N3", CultureInfo.GetCultureInfo("ru-RU")).Replace(",000", "")}".ToUpper(), Color = "1 0.9294118 0.8666667 1", FontSize = 10, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter},
        ...
        public List<ItemId> IgnoreList = new List<ItemId>();
        ...
        private Dictionary<ItemId, HashSet<ulong>> _looters = new Dictionary<ItemId, HashSet<ulong>>();
        ...
        private Dictionary<NetworkableId, ulong> LastHeliHit = new Dictionary<NetworkableId, ulong>();
        private Dictionary<NetworkableId, ulong> LastBradleyAPCHit = new Dictionary<NetworkableId, ulong>();

        private BasePlayer GetLastHeliAttacker(NetworkableId heliNetId)
        {
            ulong player;
            LastHeliHit.TryGetValue(heliNetId, out player);
            return BasePlayer.FindByID(player);
        }
        private BasePlayer GetLastBradleyAPCAttacker(NetworkableId BradleyAPCNetId)
        {
            ulong player;
        ...
        string TOP = "[{\"name\":\"Clanstop_main2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.6980392\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main3\",\"parent\":\"Clanstop_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.1 0.1 0.1 1\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2 0.1546297\",\"anchormax\":\"0.8 0.8935185\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main4\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.75 0.75 0.75 0.25\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.9385965\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main5\",\"parent\":\"Clanstop_main4\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ТОП КЛАНОВ EASY RUST</b>\",\"fontSize\":18,\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main6\",\"parent\":\"Clanstop_main5\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"Clanstop_main2\",\"color\":\"1 0 0 0.3\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.935175 0\",\"anchormax\":\"0.9986773 0.94\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main7\",\"parent\":\"Clanstop_main6\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>X</b>\",\"fontSize\":18,\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main8\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.005012453\",\"anchormax\":\"1 0.8734336\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main9\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.75 0.75 0.75 0.2\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.8809524\",\"anchormax\":\"1 0.9310777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"МЕСТО\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.03405698 0\",\"anchormax\":\"0.1355833 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main11\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"КЛАН\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1329573 0\",\"anchormax\":\"0.6983538 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ОЧКИ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4698629 0\",\"anchormax\":\"0.5670121 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"К/Д\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.3285205 0\",\"anchormax\":\"0.4685565 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main13\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ШКАФ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5485205 0\",\"anchormax\":\"0.7885565 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main16\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"РЕЙД\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.7685205 0\",\"anchormax\":\"0.9085565 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main16\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ИГРОКОВ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.8585205 0\",\"anchormax\":\"0.9985565 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},]";

        string InfoTOP = "[{\"name\":\"Clanstop_info2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.6980392\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info3\",\"parent\":\"Clanstop_info2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2 0.1546297\",\"anchormax\":\"0.8 0.8935185\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info4\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.2 0.2 0.2 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.9385965\",\"anchormax\":\"0.9953553 0.9955974\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info5\",\"parent\":\"Clanstop_info4\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>{clanname}</b> МЕСТО В РЕЙТИНГЕ: {RANK}\",\"fontSize\":18,\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info6\",\"parent\":\"Clanstop_info5\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"Clanstop_info2\",\"color\":\"0 0 0 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.935175 0\",\"anchormax\":\"0.9986773 0.94\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info7\",\"parent\":\"Clanstop_info6\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>X</b>\",\"fontSize\":18,\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info8\",\"parent\":\"Clanstop_info5\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{return}\",\"color\":\"0 0 0 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0004332103 0\",\"anchormax\":\"0.1224549 0.93\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info9\",\"parent\":\"Clanstop_info8\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>НАЗАД</b>\",\"fontSize\":16,\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info10\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.13 0.13 0.13 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.005012453\",\"anchormax\":\"0.9953553 0.7481203\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info11\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.17 0.17 0.17 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.9173692\",\"anchormax\":\"1 1.000001\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ИМЯ ИГРОКА</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"0.2528636 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>СТАТУС</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2449865 0\",\"anchormax\":\"0.4594171 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ОЧКИ</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4576665 0\",\"anchormax\":\"0.6055799 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>НОРМА в %</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6073302 0\",\"anchormax\":\"0.7771242 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>УБИЙСТВ/СМЕРТЕЙ</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.7841259 0\",\"anchormax\":\"0.9985565 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info12\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.01011801\",\"anchormax\":\"1 0.9123102\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info13\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.13 0.13 0.13 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548413 0.755639\",\"anchormax\":\"0.9953553 0.9310777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info16\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.22 0.22 0.22 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1 0.1428573\",\"anchormax\":\"0.9 0.8928576\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info17\",\"parent\":\"Clanstop_info16\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ИГРОКОВ В КЛАНЕ: {ccount}    ВСЕГО ОЧКОВ: {Points}\n\nЛИДЕР КЛАНА: {lname}    ВСЕГО ФАРМА: {ffarm}</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info18\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.03318176 0.07857105\",\"anchormax\":\"0.1382089 0.9357135\",\"offsetmax\":\"0 0\"}]}]";
        ...
        void ClanTOPInfo(BasePlayer player, Clan clan, int page)
        {
            ...
            CuiHelper.AddUi(player, InfoTOP.Replace("{clanname}", "КЛАН: " + clan.tag.ToUpper() + " | ")
                .Replace("{RANK}", GetClanIndex(clan.tag).ToString())
                 .Replace("{ccount}", clan.members.Count.ToString())
                  .Replace("{ffarm}", clan.Farm.ToString())
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.25 0.25 0.23 0" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.45 0", AnchorMax = $"0.54 0.048" },
            }, "Clanstop_info12", "clans_page");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.3 0.3 0.3 1", Command = page > 0 ? $"clanstop_info {clan.tag} {page - 1}" : "" },
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.3 0.3 0.3 1", Command = ClanMembers.Skip(11 * (page + 1)).Count() > 0 ? $"clanstop_info {clan.tag} {page + 1}" : "" },
                Text = { Text = ">", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
        ...
        string TOPs = "[{\"name\":\"Message\",\"parent\":\"Hud\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.345 0\",\"anchormax\":\"0.644 0.02\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";


        [ChatCommand("topraid")]
        void clanraider(BasePlayer player)
        {
            int page = 0;
            int i = 1;
            var ClanMembers = from pair in clans orderby pair.Value.KilledTCAll descending select pair;
            string turn;
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(3 * page).Take(ClanMembers.ToList().Count >= 3 ? 3 : ClanMembers.ToList().Count))
            {
                if ((bool)ClanTournament?.Call<bool>("CheckTournament", ulong.Parse(key.Value.owner)) == true)
                {
                    turn = "да";
                }
                else
                ...
                player.ChatMessage($"Место: {i}, тег: {key.Value.tag}, количество рейдов: {key.Value.KilledTCAll}.\nУчастие в турнире: {turn}.");
                i++;
            }
        }

        void ClanTopgs(BasePlayer player, int page)
        {
            CuiHelper.DestroyUi(player, "Message");
            CuiHelper.AddUi(player, TOPs);
            string colored = "0.8 0.6 0 0";
            var elements = new CuiElementContainer();
            double Amin = 0;
            double Amax = 0.32;
            int i = 1;
            ...
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(3 * page).Take(ClanMembers.ToList().Count >= 3 ? 3 : ClanMembers.ToList().Count))
            {
                CuiHelper.AddUi(player, ButtonListeds.Replace("{amin}", Amin.ToString()).Replace("{amax}", Amax.ToString()).Replace("{color}", colored).Replace("{id}", key.Key));

                string color;
                if (i == 1)
                {
                    color = "0.00 0.6 1 0.80";
                }
                else
                {
                    color = "1.00 0.62 0.00 0.80";
                }
                elements.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    RectTransform = { AnchorMin = "0.1675 0", AnchorMax = "1 1", OffsetMax = "0 0" },
                    Image = { Color = color }
                }, "clans_player" + key.Key, "cl" + key.Key);

                elements.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    RectTransform = { AnchorMin = "0 0", AnchorMax = "0.1675 1", OffsetMax = "0 0" },
                    Image = { Color = "1 1 1 0.2" }
                }, "clans_player" + key.Key, "cla" + key.Key);
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.tag.ToUpper(), Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"1 1" },
                }, "cl" + key.Key);
        ...
        string ButtonListeds = "[{\"name\":\"clans_player{id}\",\"parent\":\"Message\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"{color}\"},{\"type\":\"RectTransform\",\"anchormin\":\"{amin} 0\",\"anchormax\":\"{amax} 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]}]";

        [ChatCommand("tops")]
        void ClanTopg(BasePlayer player, int page)
        {
            timer.Every(3f, () =>
            {
                CuiHelper.DestroyUi(player, "Message");
        ...
        [PluginReference] private Plugin ClanTournament;
        void ClanTOP(BasePlayer player, int page)
        {
            ...
            int i = 1;
            var ClanMembers = from pair in clans orderby pair.Value.ClanPoints descending select pair;
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(13 * page).Take(ClanMembers.ToList().Count >= 13 ? 13 : ClanMembers.ToList().Count))
            {
                var clan = findClan(key.Value.tag);
                var ClanMembers2 = from pair in clan.members orderby pair.Value.PlayerPoints descending select pair;
                if (i % 2 == 0)
                {
                    colored = "0.1 0.1 0.1 0.1";
                }
                else
                {
                    colored = "0.75 0.75 0.75 0.15";
                }
                ...
                elements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiRawImageComponent {Color = "1 1 1 0", Png = (string)ImageLibrary?.Call("GetImage", key.Value.ClanAvatar)},
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{page * 13 + i}", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleLeft },
                ...
                /*elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.KillC.ToString() + "/" + key.Value.DeathC.ToString(), Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "0.1 0.9 0 0.5", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.6098629 0", AnchorMax = $"0.7070121 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.KilledTCAll.ToString(), Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "0.1 0.9 0 0.5", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.2 0", AnchorMax = $"0.4 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.CupCount.ToString(), Font = "robotocondensed-bold.ttf", FontSize = 13, Color = "0.1 0.9 0 0.5", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.4 0", AnchorMax = $"0.6 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.Farm.ToString(), Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "0.1 0.9 0 0.5", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.7898629 0", AnchorMax = $"0.8870121 1" },
                }, "clans_player" + key.Key);*/

                /*
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{clan.Farm}", Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.6585205 0", AnchorMax = $"0.7985565 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{clan.CupCount}", Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.1729573 0", AnchorMax = $"0.3285205 1" },
                }, "clans_player" + key.Key);
                */
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{key.Value.KilledTCAll}", Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.7685205 0", AnchorMax = $"0.9085565 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{clan.KillC}/{clan.DeathC}", Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.3285205 0", AnchorMax = $"0.4685565 1" },
                }, "clans_player" + key.Key);
                ...
                if ((bool)ClanTournament?.Call<bool>("CheckTournament", ulong.Parse(key.Value.owner)) == true)
                {
                    elements.Add(new CuiLabel
                    {
                        Text = { Text = "УЧАСТВУЮТ", Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "0 0.5 0 1", Align = TextAnchor.MiddleCenter },
                        RectTransform = { AnchorMin = $"0.5485205 0", AnchorMax = $"0.7885565 1" },
                    }, "clans_player" + key.Key);
                }
                else
                {
                    elements.Add(new CuiLabel
                    {
                        Text = { Text = "-", Font = "robotocondensed-bold.ttf", FontSize = 14, Color = "1 0 0 1", Align = TextAnchor.MiddleCenter },
                        RectTransform = { AnchorMin = $"0.5485205 0", AnchorMax = $"0.7885565 1" },
                    }, "clans_player" + key.Key);
                }
                elements.Add(new CuiLabel
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.4485205 0", AnchorMax = $"0.5885565 1" },
                }, "clans_player" + key.Key);
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.8685205 0", AnchorMax = $"0.9885565 1" },
                }, "clans_player" + key.Key);
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.25 0.25 0.23 0" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.45 0.003", AnchorMax = $"0.54 0.048" },
            }, "Clanstop_main8", "clans_page");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.3 0.3 0.3 1", Command = page > 0 ? $"clanstop_main {page - 1}" : "" },
                Text = { Text = "<", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.33 0.997" },
            }, "clans_page");
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.3 0.3 0.3 1", Command = clans.Keys.Skip(10 * (page + 1)).Count() > 0 ? $"clanstop_main {page + 1}" : "" },
                Text = { Text = ">", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.66 0", AnchorMax = $"0.997 0.997" },
            }, "clans_page");
            CuiHelper.AddUi(player, elements);
        ...
        void cmdClanKick(BasePlayer player, string[] args)
        {
            ...
            foreach (var value in myClan.members)
            {
                ...
                foreach (var turret in turrets)
                {
                    ...
                    foreach (var x in turret.authorizedPlayers.ToArray())
                        if (x.userid == ulong.Parse(kickPlayer.Id))
                            turret.authorizedPlayers.Remove(x);
                    // turret.authorizedPlayers.RemoveWhere(a => a.userid == ulong.Parse(kickPlayer.Id));
                }
            }
...
'\n'
        ...
        public class Clan
        {
            ...
            public void AddBasePlayer(BasePlayer basePlayer, bool flag = false)
            {
                ...
                {
                    foreach (var x in membersBasePlayer.ToArray())
                        if (x.UserIDString == basePlayer.UserIDString)
                            membersBasePlayer.Remove(x);
                    membersBasePlayer.Add(basePlayer);
                }
            }
            ...
            public void RemoveBasePlayer(BasePlayer basePlayer, bool flag = false)
            {
                if (membersBasePlayer.Any((BasePlayer x) => x.UserIDString == basePlayer.UserIDString))
                {
                    foreach (var x in membersBasePlayer.ToArray())
                        if (x.UserIDString == basePlayer.UserIDString)
                            membersBasePlayer.Remove(x);
                    // membersBasePlayer.Remove((BasePlayer x) => x.UserIDString == basePlayer.UserIDString);
                }
            }
            ...
            public static Clan Create(string tag, string description, string ownerId, string owName, string URL)
            {
                var clan = new Clan()
                {
                    ...
                    owner = ownerId,
                    ClanAvatar = "https://media.discordapp.net/attachments/942751357885104148/1018958147207053452/IMG_9730.jpg?width=507&height=676",
                    ownerName = owName,
