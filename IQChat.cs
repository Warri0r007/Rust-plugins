...
{
    [Info("IQChat", "discord.gg/9vyTXsJyKR", "2.14.54")]
    [Description("The most pleasant chat for your server from the IQ system")]
    class IQChat : RustPlugin
    {
        public static Dictionary<String, String> KeyImages = new Dictionary<String, String>()
        {
            { "UI_IQCHAT_CONTEXT_NO_RANK", "https://i.postimg.cc/D0S928z3/7-AV4e-G5-1.png"},
            { "UI_IQCHAT_CONTEXT_RANK", "https://i.postimg.cc/CdyQS7tb/dQ0ptBE.png"},
            { "IQCHAT_INFORMATION_ICON", "https://i.postimg.cc/BZdSj0fB/phcCykw.png"},
            { "IQCHAT_SETTING_ICON", "https://i.postimg.cc/BZdSj0fB/phcCykw.png"},
            { "IQCHAT_IGNORE_INFO_ICON", "https://i.postimg.cc/Fs39cB95/MEhsbTM.png"},
            { "IQCHAT_MODERATION_ICON", "https://i.postimg.cc/cLc0ktgF/2vJP8qM.png"},
            { "IQCHAT_ELEMENT_PANEL_ICON", "https://i.postimg.cc/XJd2xdXJ/afRp7O0.png"},
            { "IQCHAT_ELEMENT_PREFIX_MULTI_TAKE_ICON", "https://i.postimg.cc/Z5QVSVdn/6ohxadb.png"},
            { "IQCHAT_ELEMENT_SLIDER_ICON", "https://i.postimg.cc/2yCxwtPc/cx8ZoA7.png"},
            { "IQCHAT_ELEMENT_SLIDER_LEFT_ICON", "https://i.postimg.cc/Jzs5PZ2L/ZZP2kuy.png"},
            { "IQCHAT_ELEMENT_SLIDER_RIGHT_ICON", "https://i.postimg.cc/rmj48wPj/g0VTWKD.png"},
            { "IQCHAT_ELEMENT_DROP_LIST_OPEN_ICON", "https://i.postimg.cc/5NTC9Gnh/p9pIfXR.png"},
            { "IQCHAT_ELEMENT_DROP_LIST_OPEN_ARGUMENT_ICON", "https://i.postimg.cc/wMP7vycX/HM1AuCF.png"},
            { "IQCHAT_ELEMENT_DROP_LIST_OPEN_TAKED", "https://i.postimg.cc/W10hN4DZ/gBvkzy0.png"},
            { "IQCHAT_ELEMENT_SETTING_CHECK_BOX", "https://i.postimg.cc/053Q7SDm/tjkGj46.png"},
            { "IQCHAT_ALERT_PANEL", "https://i.postimg.cc/ZnyJwfpN/sKKsKrs.png"},
            { "IQCHAT_MUTE_AND_IGNORE_PANEL", "https://i.postimg.cc/BQHK6pkt/bOS905f.png"},
            { "IQCHAT_MUTE_AND_IGNORE_ICON", "https://i.postimg.cc/K89vvgGR/15myNzk.png"},
            { "IQCHAT_MUTE_AND_IGNORE_SEARCH", "https://i.postimg.cc/yNk6JYxn/S4c4Hc9.png"},
            { "IQCHAT_MUTE_AND_IGNORE_PAGE_PANEL", "https://i.postimg.cc/KcnG3WcX/Yo0You9.png"},
            { "IQCHAT_MUTE_AND_IGNORE_PLAYER", "https://i.postimg.cc/Dy67BbbB/JfDmg3P.png"},
            { "IQCHAT_MUTE_AND_IGNORE_PLAYER_STATUS", "https://i.postimg.cc/yd0H9JHh/dLiAv1i.png"},
            { "IQCHAT_IGNORE_ALERT_PANEL", "https://i.postimg.cc/YCjBRD7C/bJgQV1b.png"},
            { "IQCHAT_IGNORE_ALERT_ICON", "https://i.postimg.cc/wTTCx47Q/qKTHf8N.png"},
            { "IQCHAT_IGNORE_ALERT_BUTTON_YES", "https://i.postimg.cc/653Px7mH/NjQ9OVL.png"},
            { "IQCHAT_IGNORE_ALERT_BUTTON_NO", "https://i.postimg.cc/KvHHGGXm/Gzn47GY.png"},
            { "IQCHAT_MUTE_ALERT_PANEL", "https://i.postimg.cc/W4MWw0d4/f8dBS6M.png"},
            { "IQCHAT_MUTE_ALERT_ICON", "https://i.postimg.cc/3wC1v7q4/seBCx8G.png"},
            { "IQCHAT_MUTE_ALERT_PANEL_REASON", "https://i.postimg.cc/Wpfnr55n/OhyZVNY.png"},
        };
        ...
        private class InterfaceBuilder
        {
            ...
            private void BuildingIgnoreAlert()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-231 -55.003268", OffsetMax = "229.421 33.983268" }
                }
                });
            ...
            private void BuildingModerationStatic()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "11.071 -144.1883268", OffsetMax = "152.881 -129.7523268" }
                }
                });
        ...
        private new void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["IQCHAT_CONTEXT_NICK_DISPLAY_MESSAGE"] = "люблю family rust",
        ...
        /// Обновление 2.///
        /// Изменения :
        /// - Изменил обработку кланового тэга (теперь если у игрока нет клана - не будет использоваться текст из языкового файла)
        /// - Убрал лишний вызов функции (старая обработка ников)
        /// - Внедрил функцию "Перенос мута в командный чат" (существовала в КФГ - но не была активной)
        /// Исправления :
        /// - Исправил регулярное выражение на поиск запрещенных ников если в списке запрещенных слов использовался квантификатор
        /// </summary>
            ...
            private static IEnumerator AddImage()
            {
                ...
                foreach (var Key in KeyImages)
                {
                    ...
                    if (texture != null)
                    {
                        ...
                        if (!Images.ContainsKey(Key.Key))
                            Images.Add(Key.Key, image);
                        else
                            Images[Key.Key] = image;
